                ...
                <div class="modal-body">
                    ...
                    <div>
                        <div class="row">
                            ...
                            <div class="col-lg-8"><input type="text" name="ngay_bat_dau" class="form-control"></div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-lg-3">Ngày kết thúc</div>
                            <div class="col-lg-8"><input type="text" name="ngay_ket_thuc" class="form-control"></div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-lg-3">
