...
<body>
<h1>Facility List</h1>
<a href="/facility?action=update" class="btn btn-success">Update Facility</a>
<table class="table table-hover">
    ...
    <tr>
        ...
        <td>  <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <script>
                function showInfoDelete(name) {
                    document.getElementById("confirm").innerHTML="<a href='/facility?action=delete&name="+name+"'>delete</a>";
                }
            </script></td>
    </tr>
    <tr>
