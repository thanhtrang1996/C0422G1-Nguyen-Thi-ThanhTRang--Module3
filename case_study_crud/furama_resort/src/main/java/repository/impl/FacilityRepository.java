...
public class FacilityRepository implements IFacilityRepository {
    ...
    private static final String UPDATE_VILLA = " update dich_vu set ten_dich_vu =?,dien_tich =?,chi_phi_thue =?, so_nguoi_toi_da=?, tieu_chuan_phong=?" +
            " mo_ta_tien_nghi_khac=?, dien_tich_ho_boi=? , so_tang=?, ma_kieu_thue=?, ma_loai_dich_vu=? where ma_dich_vu = ?";
    private static final String UPDATE_HOUSE = " update dich_vu set ten_dich_vu =?,dien_tich =?,chi_phi_thue =?, so_nguoi_toi_da=?, tieu_chuan_phong=?" +
            " mo_ta_tien_nghi_khac=? , so_tang=?, ma_kieu_thue=?, ma_loai_dich_vu=? where ma_dich_vu = ?";
    private static final String UPDATE_ROOM = " update dich_vu set ten_dich_vu =?,dien_tich =?,chi_phi_thue =?, so_nguoi_toi_da=?,  dich_vu_mien_phi_di_kem = ?" +
            " ma_kieu_thue=?, ma_loai_dich_vu=? where ma_dich_vu = ?";
    ...
    @Override
    public List<Facility> searchFacilityByName() {
        Connection connection = DBConnect.getConnectDB();
        List<Facility> facilityList = new ArrayList<>();
        try {
